...
extension AllColors on BuildContext {
  ...
  DSColor getContainerTextColor(DSColor? backgroundColor) {
    ...
    if (backgroundColor == colorPalette.brand.primaryContainer) return colorPalette.brand.onPrimaryContainer;
    if (backgroundColor == colorPalette.brand.secondaryContainer) return colorPalette.brand.onSecondaryContainer;
    if (backgroundColor == colorPalette.brand.tertiaryContainer) return colorPalette.brand.onTertiaryContainer;
    if (backgroundColor == colorPalette.semantic.errorContainer) return colorPalette.semantic.onErrorContainer;
    if (backgroundColor == colorPalette.semantic.successContainer) return colorPalette.semantic.onSuccessContainer;
    if (backgroundColor == colorPalette.semantic.warningContainer) return colorPalette.semantic.onWarningContainer;
    if (backgroundColor == colorPalette.semantic.infoContainer) return colorPalette.semantic.onInfoContainer;
    if (backgroundColor == colorPalette.surface.surface) return colorPalette.surface.onSurface;
    if (backgroundColor == colorPalette.surface.surfaceVariant) return colorPalette.surface.onSurfaceVariant;
