...
Widget buildErrorCard(BuildContext context) {
  ...
  final hasRetry = context.knobs.boolean(label: 'Has Retry Button', initialValue: false);
  
  final errorTypes = [
    ('Default Error', 'Something went wrong, please try later'),
    ('Network Error', 'No internet connection. Please check your network settings and try again.'),
  ...
  final showQuickOptions = context.knobs.boolean(label: 'Show Quick Options', initialValue: false);
